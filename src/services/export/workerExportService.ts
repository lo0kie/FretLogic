 ...
 */
import { computeSongKey, getChordName } from '@/services/music/theory';
...
import { charKey, collectEdgeChordIds } from '@/utils/score/scoreModel';
import type {
  ExportChordData,
  ExportLineItem,
  WorkerExportMessage,
...
export const runWorkerExport = (
  ...
  return new Promise((resolve, reject) => {
    ...
    const worker = new Worker(new URL('@/workers/scoreExportWorker.ts', import.meta.url), {
      type: 'module',
    });
